...
with tab3:
    ...
    if selected_food is not None:
        ...
        st.caption(f"Model accuracy: MAE {gluc_pkg.get('mae','N/A')} mg/dL | "
                   f"R² {gluc_pkg.get('r2','N/A')} | "
                   f"Directional accuracy {gluc_pkg.get('dir_accuracy', gluc_pkg.get('directional_accuracy','~72'))}% | "
